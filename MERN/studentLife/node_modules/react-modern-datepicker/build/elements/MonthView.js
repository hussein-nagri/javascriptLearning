...
var MonthView = function MonthView(props) {
  ...
  return _react["default"].createElement(_Wrapper["default"], null, _react["default"].createElement(_Header["default"], null, months.map(function (month, k) {
    return currentMonth === month.m ? _react["default"].createElement(SelectedSpan, {
      isMax: month.isMax,
      isMin: month.isMin,
      key: k,
    ...
    }, month.m) : _react["default"].createElement(YSpan, {
      isMax: month.isMax,
      isMin: month.isMin,
      key: k,
      onClick: function onClick() {
